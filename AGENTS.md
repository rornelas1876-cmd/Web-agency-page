# AGENTS.md — WebPro México Landing Page

This document is for AI agents and developers working on this codebase.

## Project Overview

A high-converting marketing landing page for a Mexican web design and digital automation agency. Built with TanStack Start (SSR React) and deployed on Netlify. The page acts as a sales funnel sent via cold email to businesses without websites.
